...
- Provide `mailto:` actions for `hello@velorah.com`.
- Reveal section content once as it enters the viewport, without an animation dependency.
- Declare local SVG favicon and Open Graph/Twitter identity assets.
...
- Keep content and layout usable when remote fonts or media are unavailable; no poster or alternate video is promised.
- Preconnect public font and media origins without exposing credentials.
- Pass lint, 14-test component suite, coverage thresholds, audit, docs validation, production build, and multi-viewport browser QA.
...
- Production-domain canonical/`og:url` values and raster social-card generation before hosting is selected.
...
- [Browser QA](../plans/260718-2001-velorah-professional-web-polish/reports/browser-qa-2026-07-18-professional-polish.md)
...
- [UI/UX audit](../plans/260718-2001-velorah-professional-web-polish/reports/ui-ux-designer-2026-07-18-professional-polish.md)

## Unresolved questions

- None for the current repository scope. Production origin and raster share-card policy remain deployment inputs.
